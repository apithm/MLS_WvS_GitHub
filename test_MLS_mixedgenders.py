...
path_save = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\All_cls_4class_1vs1_OVR_mixed_gender\\'
...
path = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\Full_ECG_EEG_4class_mixed_gender\\'
path_2 = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\Full_ECG_EEG_4class_OVR_mixed_gender\\'
...
for classifier_chosen_count_list_count in range(len(N_classifier_chosen_list)):
    ...
    for comb_count in list(comb):
        ...
        dataset_test = 'ECG_EEG_mixed_baseline_exp_OVR_' + str(class_tobetested) + 'vsRest_test'


        filenam_test = dataset_test + '.csv'
        path_test_file = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\ECG & EEG_2\\'
