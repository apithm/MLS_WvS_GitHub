...
for condition_count in range(0,1):
    ...
    dataset_train = 'ECG_EEG_' + gender + '_' + condition + 'All_exp_' + level + '_train'
    # print(dataset)


    path = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\ECG & EEG_2_1\\Gender\\CtrlAllvsExp1\\'
    filename = dataset_train + '.csv'
    fullname = path + filename

    savepath='D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\Full_ECG_EEG_2types_Allvs1class_' + gender +'_gender\\'
