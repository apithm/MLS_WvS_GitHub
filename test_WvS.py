...
# N_classifier_chosen_list=[1,2,3,4,5,6,7]
# N_classifier_chosen_list=[13,14,15,16,17,18,19,20]
# N_classifier_chosen_list=[12]
# N_classifier_chosen_list=[1,19,20]
# N_classifier_chosen_list=[10]
N_classifier_chosen_list=[11]
...
path_save = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\All_cls_2_types_Allvs1&AllvsAll_class_' + gender + '_gender\\'
...
for classifier_chosen_count_list_count in range(len(N_classifier_chosen_list)):
    ...
    for comb_count in list(comb):
        ...
        dataset_test = 'ECG_EEG_' + gender + '_controlAll_exp_' + str(class_tobetested) + '_test'


        filenam_test = dataset_test + '.csv'
        path_test_file = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\ECG & EEG_2_1\\Gender\\CtrlAllvsExp1\\'
