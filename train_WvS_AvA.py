...
for condition_count in range(0,1):
    ...
    path = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\ECG & EEG_2_1\\Gender\\CtrlAllvsExpAll\\'
    filename = dataset_train + '.csv'
    fullname = path + filename

    savepath='D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\Full_ECG_EEG_2types_allclass_' + gender +'_gender\\'
