...
for condition_count in range(0,1):
    ...
    prefix = 'mixed features_' + condition + '_class_' + level + '_'   

    dataset_train = 'ECG_EEG_' + gender + '_' + condition + '_exp_OVR_' + level + 'vsRest_train'
    # print(dataset)


    path = 'D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\ECG & EEG_2\\Gender\\'
    filename = dataset_train + '.csv'
    fullname = path + filename

    savepath='D:\\Dropbox\\NECTEC\\My Documents\\StressClassification_NRIIS\\Result\\Full_ECG_EEG_4class_OVR_' + gender +'_gender\\'
...
rows=['baseline acc.','baseline std.']
